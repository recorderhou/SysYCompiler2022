...
%token INT RETURN
%token <str_val> IDENT LEQ GEQ NEQ EQ AND OR
%token <int_val> INT_CONST

// 非终结符的类型定义
%type <ast_val> FuncDef FuncType Block Stmt Number Exp UnaryExp PrimaryExp UnaryOp MulExp AddExp LOrExp LAndExp RelExp EqExp
